...
// Copiado de sistema-gestion-obras/frontend/src/app/shared/kpi-card — mismo
// look de tarjeta KPI (borde de color + ícono) que el resto de Buildrr.
interface ColorMap {
  border: string;
  text: string;
  bgTint: string;
...
export class KpiCardComponent {
  ...
  @Input() icon?: string;
  @Input() tinted = false;
  /** El bloque completo es clickeable si se pasa un handler (accesos rápidos del dashboard). */
